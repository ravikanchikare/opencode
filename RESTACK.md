...
latest candidate is based on `6ee2ed7510c971415a312273c9bf9e2364c6d948` and is
...
3. Publish the latest upstream rebase only with the exact published-fork lease:

   ```sh
   git push origin HEAD:refs/heads/v2 \
     --force-with-lease=refs/heads/v2:f8692371ccc9e63cc3e130ced48e550a098b2dae
   ```
