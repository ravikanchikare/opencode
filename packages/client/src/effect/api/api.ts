...
export type PluginSetOptionsOutput = { readonly location: Location.PublicRef; readonly data: Plugin.Info }
...
export type SkillInventoryInput = { readonly location?: { readonly directory?: string | undefined } | undefined }
export type SkillInventoryOutput = {
  readonly location: Location.PublicRef
  readonly data: ReadonlyArray<Skill.Inventory>
}
