...
export const dict = {
  ...
  "settings.skills.error.load": "Skills could not be loaded",
  "settings.skills.error.save": "Skill request failed",
  "settings.skills.error.refresh": "Skill availability saved, but refresh failed",
  ...
  "settings.plugins.capability.server": "Server",
  "settings.plugins.capability.tui": "Terminal UI",
  "settings.plugins.capability.rpc": "RPC",
  "settings.plugins.source.builtin": "Built-in",
  "settings.plugins.source.sdk": "SDK",
  "settings.plugins.noOptions": "This plugin has no configurable options.",
  "settings.plugins.activation": "Plugin activation is managed through OpenCode configuration.",
  "settings.plugins.search": "Search choices or operations…",
  "settings.plugins.empty": "No matching choices or operations.",
  "settings.plugins.selected": "{{selected}} of {{total}} selected",
  "settings.plugins.operations.one": "{{count}} operation",
  "settings.plugins.operations.other": "{{count}} operations",
  "settings.plugins.selectAll": "Enable all",
  "settings.plugins.clearAll": "Disable all",
  "settings.plugins.reset": "Use default",
  "settings.plugins.applying": "Applying…",
  "settings.plugins.notActive": "Saved selection is not active.",
  "settings.plugins.saveFailed": "Plugin options could not be applied",
  "settings.plugins.default": "Changes apply as the default for every project.",
  "settings.plugins.inherited": "Using the default selection. Changes override it for this project.",
  ...
  "settings.plugins.loadFailed": "Could not load plugins",
  ...
  "project.settings.extensions.mcp": "MCP",
  "project.settings.extensions.languageServers": "Language servers",
