...
/** SkillInstructions advertises described skills unless they explicitly opt out. */
export function autoInvokeEnabled(skill: Pick<SkillRow, "description" | "autoinvoke">) {
  return skill.description !== undefined && skill.autoinvoke !== false
}
