...
const getBase = (appId: string): Configuration => ({
  ...
  dmg: adHocSigning ? { sign: false } : undefined,
  protocols: {
    name: productName,
  ...
  switch (channel) {
    ...
    case "beta": {
      return {
        ...
        publish: publishFor(
          { provider: "generic", url: "https://opencode.ai/update/api/beta/desktop/opencode/", channel: "latest" },
          appId,
        ),
        deb: { fpm },
    ...
    case "prod": {
      return {
        ...
        protocols: { name: productName, schemes: [deepLinkScheme] },
        publish: publishFor(
          { provider: "generic", url: "https://opencode.ai/update/api/latest/desktop/opencode/", channel: "latest" },
          appId,
        ),
